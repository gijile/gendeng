...
public:
    ...
    // Get all workers
    std::vector<ServiceWorkerInstance> getWorkers() const {
        return workers;
    }
    ...
    // Get all tasks
    std::vector<BackgroundTask> getTasks() const {
        return tasks;
    }

    // Get all messages
    std::vector<ServiceWorkerMessage> getMessages() const {
        return messages;
    }

    // Get all caches
    std::vector<CacheInfo> getCaches() const {
        return caches;
    }

    // Get all sync events
    std::vector<SyncEvent> getSyncEvents() const {
        return syncEvents;
    }
